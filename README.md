...
1. **Draft it:** Fork this repository and create a new Markdown file for your proposition. Name it according to the next available number (e.g., `12.md`).
2. **Open a PR:** Open a Pull Request (PR) to this repository (`flokiorg/feps`). 
3. **Share it in Discord:** Join the Lokichain Discord and drop your PR link in the 💬 **#discussion** channel.
4. **Get the Role:** A maintainer will do a quick validity check (we are not judging the idea, just filtering spam) and grant you the `@FEP Author` role.
5. **Publish & Discuss:** Use your new role to create an official thread in the 🧩 **#feps** Discord forum. 
...
All FEPs submitted to this repository must be placed in the public domain or licensed under [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) to ensure they remain free and open for anyone to build upon.
